...
//  Refining is a Deflation token with a 2% Rewards redistribution & 2% Deflation

// Refining(REFI) is a modified fork of RFI
 ...
 * Medium:  https://medium.com/@refiningfinance
 * Twitter: https://twitter.com/RefiningFinance
 * Telegram: https://t.me/refiningfinance
 * Discord: https://discord.gg/jpYEm5tpb2
 
 * Website: http://refining.finance/
 * Contract us: info@Refining.Finance
...
contract refining is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = .1 * 10**7 * 10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'Refining.Finance';
    string private _symbol = 'REFI';
    uint8 private _decimals = 9;
    
    uint256 private _taxFee = 2;
    uint256 private _burnFee = 2;
    uint256 private _maxTxAmount = 2500e10;
